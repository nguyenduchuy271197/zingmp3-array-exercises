...
1. Write a function that takes the array as input and returns the total duration of all the songs in seconds.
2. Write a function that takes the array and an artist name string as inputs and returns a new array with only the songs by that artist.
3. Write a function that takes the array and a distributor name string as inputs and return the titles of all the songs for that distributor.
4. Write a function that takes the array as input and return the title and artists of any song that has more than one artist.
5. Write a function that takes the array as input and returns a new array with only the indie songs.
